...
public class HomeActivity extends AppCompatActivity {
    ...
    private void startCamera() {
        ...
        mCameraView.bindToLifecycle((LifecycleOwner) HomeActivity.this);

        mCameraView.setCaptureMode(CameraView.CaptureMode.VIDEO);

        mCameraView.setDrawingCacheQuality(View.DRAWING_CACHE_QUALITY_HIGH);
        ...
        final  InProgress inProgress = new InProgress(HomeActivity.this);
        predictionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        inProgress.off();
                        Intent intent = new Intent(HomeActivity.this, PredictionServiceActivity.class);
